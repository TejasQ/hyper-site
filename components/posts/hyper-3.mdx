...
<div className="date">
  {new Date('2019-01-29T20:14:47.175Z').toLocaleString('en-US', {
...
<Contributors
  people={[onecamp, tyriar, jerch, stanzilla, chabou, tejaskumar]}
/>
...
[@tyriar](https://github.com/tyriar) (from xterm.js and VSCode), [was coming back from a "vacation"](https://twitter.com/Tyriar/status/1064932797016489984) where he
